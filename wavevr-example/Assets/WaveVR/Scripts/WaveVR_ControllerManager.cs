...
public class WaveVR_ControllerManager : MonoBehaviour
{
    ...
    private void checkConnection()
    {
        ...
        {
            _connected_D = WaveVR_Controller.Input(WaveVR_Controller.EDeviceType.Dominant).connected;
            _connected_ND = WaveVR_Controller.Input(WaveVR_Controller.EDeviceType.NonDominant).connected;
        } else
        #endif
        {
