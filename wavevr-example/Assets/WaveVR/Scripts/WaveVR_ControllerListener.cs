            ...
            while (true) {
                ...
                if (isEditorMode)
                {
                    if (!WaveVR.Instance.isSimulatorOn) {
                        ...
                        {
                            if (_connected)
                            _pressed = WaveVR_Utils.WVR_GetInputButtonState_S ((int)_type, (int)WVR_InputId.WVR_InputId_Alias1_Menu);
                        }
                    }
                } else
                #endif
            ...
            while (true) {
                ...
                if (isEditorMode)
                {
                    if (!WaveVR.Instance.isSimulatorOn) {
                        ...
                        {
                            if (_connected)
                                _pressed = WaveVR_Utils.WVR_GetInputButtonState_S ((int)_type, (int)WVR_InputId.WVR_InputId_Alias1_Grip);
                        }
                    }
                } else
                #endif
            ...
            while (true) {
                ...
                if (isEditorMode)
                {
                    if (!WaveVR.Instance.isSimulatorOn) {
                        ...
                        {
                            if (_connected)
                                _pressed = WaveVR_Utils.WVR_GetInputButtonState_S ((int)_type, (int)WVR_InputId.WVR_InputId_Alias1_Touchpad);
                        }
                    }
                } else
                #endif
