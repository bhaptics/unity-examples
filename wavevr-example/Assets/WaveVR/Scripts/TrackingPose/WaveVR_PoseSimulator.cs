...
public class WaveVR_PoseSimulator : MonoBehaviour
{
    ...
    private WVR_DevicePosePair_t pose_left = new WVR_DevicePosePair_t();
    ...
    private const ulong Input_Mask_DPadUp      = 1UL << (int)WVR_InputId.WVR_InputId_Alias1_DPad_Up;
    ...
    public bool GetButtonPressState(WVR_DeviceType type, WVR_InputId button) 
    {
        ...
        case WVR_DeviceType.WVR_DeviceType_Controller_Right:
            ...
            case WVR_InputId.WVR_InputId_Alias1_DPad_Up:
                if ((btn_right.BtnPressed & Input_Mask_DPadUp) != 0)
                    _ret = true;
                break;
            default:
                break;
        ...
        case WVR_DeviceType.WVR_DeviceType_Controller_Left:
            ...
            case WVR_InputId.WVR_InputId_Alias1_Trigger:
                ...
                break;
            case WVR_InputId.WVR_InputId_Alias1_DPad_Up:
                if ((btn_left.BtnPressed & Input_Mask_DPadUp) != 0)
                    _ret = true;
                break;
            default:
                break;
    ...
    public bool GetButtonTouchState(WVR_DeviceType type, WVR_InputId button)
    {
        ...
        case WVR_DeviceType.WVR_DeviceType_Controller_Right:
            ...
            case WVR_InputId.WVR_InputId_Alias1_Trigger:
                ...
                break;
            case WVR_InputId.WVR_InputId_Alias1_DPad_Up:
                if ((btn_right.BtnTouched & Input_Mask_DPadUp) != 0)
                    _ret = true;
                break;
            default:
                break;
        ...
        case WVR_DeviceType.WVR_DeviceType_Controller_Left:
            ...
            case WVR_InputId.WVR_InputId_Alias1_Trigger:
                ...
                break;
            case WVR_InputId.WVR_InputId_Alias1_DPad_Up:
                if ((btn_left.BtnTouched & Input_Mask_DPadUp) != 0)
                    _ret = true;
                break;
            default:
                break;
    ...
    public void Update()
    {
        ...
        if (Input.GetMouseButtonDown(1))   // right mouse key
        {
            ...
            btn_right.BtnPressed |= Input_Mask_DPadUp;
            ...
            //btn_right.BtnTouched |= Input_Mask_DPadUp;
            axis_right.x = axis_x;
            axis_right.y = axis_y;
        }
        ...
        if (Input.GetMouseButtonDown(0))        // left mouse key
        {
            ...
            //btn_left.BtnPressed |= Input_Mask_DPadUp;
            ...
            btn_left.BtnTouched |= Input_Mask_DPadUp;
            axis_left.x = axis_x;
            axis_left.y = axis_y;
        }
